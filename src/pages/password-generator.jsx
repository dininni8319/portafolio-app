  ...
  return (
    <div  className='w-full'>
      <div className='w-screen h-[30vh] lg:h-[40vh] relative'>
        ...
        <Image className='absolute z-1' fill={true} style={{ objectFit: 'cover'}} src={password} alt='password' />
     ...
     <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8'>
       <div className='col-span-4'>
        ...
        <Link target='_blanck' href='https://angular-password-generator-sage.vercel.app'>
          <button className='px-8 py-2 mt-4 mr-8'>
            DEMO
          </button>
        </Link>
        <Link target='_blanck' href='https://github.com/dininni8319/angular-password-generator'>
