  ...
  return (
    <div  className='w-full'>
      <div className='w-screen h-[30vh] lg:h-[40vh] relative'>
        ...
        <Image className='absolute z-1' fill={true} style={{ objectFit: 'cover'}} src={whackBug} alt='whack a bug' />
        <div className='text-white z-10 p-2 absolute top-[50%] top-md-[60%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] traslate-y-[-50]'>
          <h2 className='py-2'>Whack a Bug</h2>
     ...
     <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8'>
       <div className='col-span-4'>
        ...
        <Link target='_blanck' href='https://web-platform-okaudw.vercel.app'>
          <button className='px-8 py-2 mt-4 mr-8'>
            DEMO
          </button>
        </Link>
        <Link target='_blanck' href='https://github.com/dininni8319/web-platform-okaudw'>
