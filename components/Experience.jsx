          ...
          <ol class="grid md:grid-cols-3 lg:grid-cols-5 gap-2">
              ...
              <li class="relative mb-6 sm:mb-0 ">
                  ...
                  <div class="mt-3 sm:pr-8 shadow-xl shadow-gray-400 rounded-xl p-2">
                      ...
                      <p class="text-base font-normal text-gray-500 dark:text-gray-400">Hackademy</p>
                  </div>
              </li>
              <li class="relative mb-6 sm:mb-0">
                  <div class="flex items-center">
               ...
               <li class="relative mb-6 sm:mb-0">
                  <div class="flex items-center">
                   ...
                   <div class="mt-3 sm:pr-8 shadow-xl shadow-gray-400 rounded-xl p-2">
                      ...
                      <time class="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">September, 2023</time>
